...
<?php include('menu.php'); ?>
	<div id="page-bgbtm">
		...
		<div id="content">
			<div class="post">
				<h2 class="title">Commercial Parking</h2>
				<div style="clear: both;">&nbsp;</div>
				
			<form id="target" action="booking.php" method="POST" name="input">
				<span>Booking type:</span>
				<input type="text" id="type" name="type" readonly value="commercial"/><br>
				<span>Vehicle Type:</span>
				<input type="text" id="vehicle" name="vehicle" readonly value="2wheeler"/><br/>
				...
				<select name="slot" id="selectslot">
