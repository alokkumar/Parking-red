...
<?php include('menu.php'); ?>
	<div id="page-bgbtm">
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Residential Parking</a></h2>
				<div style="clear: both;">&nbsp;</div>
				<table>
		
					<tr height="200px">
						<td><image src="images/2wheeler.png"> </td>
						<td><a href="residential2wheeler.php">2 Wheeler Booking</a>  </td>
					</tr>
					<tr>
						<td><image src="images/4wheeler.png"> </td>
						<td><a href="residential4wheeler.php">4 Wheeler Booking</a>  </td>
					</tr>
